-- ============================================
-- NEXUS AI AGENCY OS - SUPABASE SCHEMA (CUSTOM AUTH)
-- ============================================
-- Sistema de autenticación custom (sin Supabase Auth)
-- Solo Founder/CTO pueden crear usuarios desde el dashboard
-- ============================================
